...
<div class="uk-margin-large-bottom">
	<article id="post-<?php the_ID(); ?>" <<?php post_class( 'uk-article' ); ?>>
		...
		<div class="uk-article-meta uk-width-1-1"><?php the_time('F jS, Y'); ?> <?php _e( 'Posted in', 'MDGM' ); ?> <?php the_category(', '); ?></div>
		<div class="uk-grid">
...
<div class="uk-margin-large-bottom">
		...
		<div class="uk-article-meta"><?php the_time('F jS, Y'); ?> <?php _e( 'Posted in', 'MDGM' ); ?> <?php the_category(', '); ?></div>
		<div class="article-content">
		 <?php the_excerpt(); ?>
		</div>
